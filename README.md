...
* [CleanArchitecture](https://github.com/zamat/zamat-clean-architecture) - (ASP.NET Core 7) Solution template for creating an application following the principles of Clean Architecture, Domain Driven Design, CQRS , OpenTelemetry 
