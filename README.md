...
* [Easify](https://github.com/icgam/easify) - Framework to build easy to setup Microservices API in Asp.Net Core with cross cutting concerns (validation, mapping, exception handling, etc) and fluent bootstrapping
