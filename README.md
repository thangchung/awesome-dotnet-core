...
* [dotnet new caju](https://github.com/ivanpaulovich/dotnet-new-caju) - dotnet new template for .NET Back-ends. Increases productivity to design applications based on Hexagonal, Clean or Event Sourcing architectures styles. Support multiple data access frameworks (MongoDB, EntityFramework, Dapper or Kafka).
