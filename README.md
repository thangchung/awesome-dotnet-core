...
* [Weapsy.Mediator](https://github.com/Weapsy/Weapsy.Mediator) - Mediator for .NET Core that can be used in many scenarios, from a simple command/query pattern to a more complex CQRS with Event Sourcing.
