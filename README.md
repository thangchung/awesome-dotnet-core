...
* [kryptos](https://github.com/vijayshinva/kryptos) - A .NET core tool for cryptography. Decode JWT tokens, generate file hashes with this cross platform CLI tool.
