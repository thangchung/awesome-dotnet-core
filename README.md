...
* [KickStart](https://github.com/loresoft/KickStart) - Application bootstrap start-up helper to initialize things like an IoC container, register mapping information or run a task.
