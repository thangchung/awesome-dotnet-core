...
* [PGPCore](https://github.com/mattosaurus/PgpCore) - .NET Core class library for using PGP.
...
* [Sentry](https://github.com/getsentry/sentry-dotnet) - .Net Core Integration of the famous logging service.
