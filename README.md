...
* [GrandNode](https://github.com/grandnode/grandnode2) - Multi-platform, free, open source ecommerce shopping cart based on ASP.NET Core 5.0 and MongoDB. Fully based on GPL-3 license without hidden fees.
