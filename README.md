...
* [RavenDB](https://ravendb.net) - The lightning fast and easy-to-use open source NoSQL database with multi-document ACID transactions. Built with .NET Core, support for Windows and Linux, on-premise and cloud.
