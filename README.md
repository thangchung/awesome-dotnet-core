...
* [EvenCart](https://github.com/evencart/evencart) - Open Source Hybrid eCommerce Software that goes 'Headless' - built on top of ASP.NET Core and Liquid templates.
