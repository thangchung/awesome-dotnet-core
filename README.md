...
* [dotnet new caju](https://github.com/ivanpaulovich/dotnet-new-caju) - dotnet new templates for .NET Back-ends with awesome architecture styles! Increases productivity to design layered applications based on Hexagonal, Clean or Event Sourcing architectures styles. It support multiple data access frameworks (MongoDB, EntityFramework, Dapper or Kafka) and is completely testable.
