...
* [Core.Ocelot](https://github.com/younos1986/Core.Ocelot) - Core.Ocelot is an ASP.NET Core middleware to implement API Gateways in Microservice based applications.
