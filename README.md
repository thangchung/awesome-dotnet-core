...
* [NetBeauty 2](https://github.com/nulastudio/NetBeauty2) - Simple library to move a .NET Framework/.NET Core app runtime components and dependencies into a sub-directory and make it beauty.
